var Main = {
	...
	create: function () {
		...
		var txtStart = game.add.text(game.width/2, game.height/2+45, "Start Game", {font:"bold 40px LilyUPC", fill:"#40c643", align:"center"});
		txtStart.anchor.setTo(0.5);
		txtStart.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);

		var txtTitle = game.add.text(game.width/2, game.height/2-10, "Alien Defense", {font:"bold 100px LilyUPC", fill:"#40c643", align:"center"});
